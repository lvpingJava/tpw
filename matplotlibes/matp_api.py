...
class OcrAPI:
    ...
    def __init__(self, exePath, argsStr=""):
        ...
        # 处理启动参数
        args = ' --models=models --det=besdet.onnx --cls=bescls.onnx --rec=becrec.onnx  --keys=besch.txt --padding=150 --maxSideLen=1024 --boxScoreThresh=0.5 --boxThresh=0.3 --unClipRatio=1.6 --doAngle=0 --mostAngle=1'
